...
// GET METHOD: Fetch Loans that are rejected
router.get(
  "/loanApplication/getLoanApplicationAccountingRejected",
  async (req: Request, res: Response): Promise<any> => {
    try {
      const pool = await connectToDatabase();
      const result = await pool.request().query(`
...
router.patch(
  "/loanApplication/assessLoanApplication/:application_id",
  async (req: Request, res: Response): Promise<any> => {
    const data = req.body;
...
router.post(
  "/loanApplication/rejectApplicationOffice",
  async (req: Request, res: Response): Promise<any> => {
    const data = req.body;
...
router.post(
  "/loanApplication/rejectApplicationCoMaker",
  async (req: Request, res: Response): Promise<any> => {
    const data = req.body;
