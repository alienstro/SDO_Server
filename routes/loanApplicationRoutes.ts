...
router.get('/loanApplication/currentLoanApplication/:applicantId', async (req: Request, res: Response): Promise<any> => {
    try {
...
router.get('/loanApplication/LoanApplicationStatus/:applicantId', async (req: Request, res: Response): Promise<any> => {
    try {
...
router.get('/loanApplication/loanHistory/:applicantId', async (req: Request, res: Response): Promise<any> => {
    try {
        const { applicantId } = req.params;
...
router.get('/loanApplication/officeStatus/:applicantId', async (req: Request, res: Response): Promise<any> => {
    try {
        const { applicantId } = req.params;
...
router.get('/loanApplication/borrowersInformationById/:applicationId', async (req: Request, res: Response): Promise<any> => {
    try {
...
router.get('/loanApplication/coMakersInformationById/:applicationId', async (req: Request, res: Response): Promise<any> => {
    try {
        const { applicationId } = req.params;
...
router.get('/loanApplication/getAssessmentDetailsById/:applicationId', async (req: Request, res: Response): Promise<any> => {
    try {
        const { applicationId } = req.params;
...
router.get('/loanApplication/getApplicant/:applicantId', async (req: Request, res: Response): Promise<any> => {
    try {
        const { applicantId } = req.params;
...
async function updateLoanStatusHistory(initiator: string, application_id: number, transaction: sql.Transaction): Promise<void> {
    try {
        let remarkMsg = '';
...
router.patch('/loanApplication/updateApprovalOSDS', async (req: Request, res: Response): Promise<any> => {
    try {
